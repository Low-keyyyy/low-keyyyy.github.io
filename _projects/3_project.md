...
{% include figure.liquid path="assets/img/p3-1.png" title="Homepage" class="img-fluid rounded z-depth-1" zoomable=true %}
<div class="caption">
    The landing page welcoming users to the intelligent workspace.
</div>

{% include figure.liquid path="assets/img/p3-2.png" title="Mainpage" class="img-fluid rounded z-depth-1" zoomable=true %}
<div class="caption">
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/p3-3.png" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/p3-4.png" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/p3-5.png" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/p3-6.png" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/p3-7.png" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
